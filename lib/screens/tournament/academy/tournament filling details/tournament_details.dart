...
class _TournamentDetailsState extends State<TournamentDetails> {
  ...
  //   if(widget.selectedDataForCat.isNotEmpty){
  //     selectDataCat = widget.selectedDataForCat;
  //   }if(widget.selectedDataForFee.isNotEmpty){
  //     selectDataFee = widget.selectedDataForFee;
  //   }if(widget.tournamentUUID.isNotEmpty){
  //     tournamentId = widget.tournamentUUID;
  //   }if(widget.toruSlots.isNotEmpty){
  //     tournamentSlotDesc = widget.toruSlots;
  //     desController.text =tournamentSlotDesc;
  //   }
  // }
                      ...
                      if (provider.selectedDataForCat.isNotEmpty) ...[
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return (provider.selectedDataForCat[index]['categories'].length != 0 )
                                ? Padding(
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: ListView.builder(
                                                    ...
                                                    itemCount: provider.selectedDataForCat[index]['categories'].length,
                                                    itemBuilder: (context, idx) => Container(
                                                            ...
                                                            child: Text(
                                                              provider.selectedDataForCat[index]['categories'][idx],
                                                              style: const TextStyle(
                                                                  fontWeight:FontWeight.w500,
                                                                  fontSize: 14,
                                                                  color: (MyAppTheme.whiteColor)),
                      ...
                      ElevatedButton(
                          onPressed: (){
                            ...
                            provider.saveDetails(
                                context: context,
                                tournamentUUId: widget.tournamentUUID,
                                //'235670ad-5ac0-4f22-9205-3578b07f58a1',
                                description: desController.text,
                                selectedCategoriesData: provider.selectedDataForCat,
                                selectedFeeData: provider.selectDataForFee);
