...
class _StaffMembersListScreenState extends State<StaffMembersListScreen> {
 ...
 void initState() {
   super.initState();
   Future.delayed(Duration.zero).then((value) => context.read<AdminStaffProvider>().getStaffListData(context: context));
   //locator<AdminStaffProvider>().getStaffListData(context: context));
 }
 ...
 @override
  ...
  Widget build(BuildContext context) {
   //  bool isLoading= Provider.of<AdminStaffProvider>(context).isLoading;
   resultList = Provider.of<AdminStaffProvider>(context).resultList;

        return Scaffold(
          appBar: mAppBar(title: staffMembers),
          body: (resultList.isEmpty)? const Progressbar() :Consumer<AdminStaffProvider>(
